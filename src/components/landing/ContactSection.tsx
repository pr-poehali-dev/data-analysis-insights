...
const ContactSection = () => {
  ...
  return (
    <section id="contact" ref={ref} className="py-20 bg-zinc-900 relative overflow-hidden">
      ...
      >
        <h2 className="text-5xl font-bold mb-4 text-center text-zinc-200">Связаться с AXEL</h2>
        <p className="text-center text-zinc-400 mb-10 max-w-lg mx-auto">Хочешь коллаборацию, концерт или просто поговорить о музыке? Пиши — отвечу каждому.</p>
        <div
